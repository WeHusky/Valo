...
<body>
    <main>
        <section class="h-screen bg-cover bg-center flex flex-col items-center justify-center text-white" style="background-image: url('/VALORANT/public/images/login3.jpg');">
            ...
            <button id="registerButton" class="px-12 py-4 bg-[#ECE8E1] border-4 border-[#ECE8E1] text-[#FF4655] font-bold text-xl tracking-wider hover:bg-[#ECE8E1]/70 hover:text-[#FF4655]/90 transition-all duration-300 rounded-none shadow-[0_0_0_2px_#ECE8E1_inset]">
                REGISTER
            </button>
        </section>
        ...
        <div id="loginModal" class="hidden fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div class="relative w-full max-w-md p-8 bg-zinc-900/80 backdrop-blur-lg border border-zinc-700 rounded-lg shadow-2xl shadow-red-500/20">
                ...
                <h2 class="valorant-text text-5xl text-white text-center mb-6" style="font-size: 45px;">
                    CREATE ACCOUNT
                </h2>
                ...
                <form action="/VALORANT/app/register.process.php" method="POST">
                    <div class="space-y-4">
                        <div>
                            <label for="name" class="block text-sm font-bold text-zinc-300 uppercase tracking-wider">Full Name</label>
                        ...
                        <button type="submit"
                                class="w-full mt-4 px-12 py-3 bg-[#FF4655] text-white font-bold text-lg tracking-wider
                                       hover:bg-red-600 transition-all duration-300 rounded-md valorant-text" style="font-size: 18px;">
                            REGISTER
                        </button>
                    </div>
                </form>
    ...
    <script>
        ...
        // Saat tombol register diklik, panggil fungsi openModal
